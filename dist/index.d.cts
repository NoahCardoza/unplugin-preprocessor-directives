import { U as UserOptions, D as Directive, I as IfToken, a as IfStatement, b as DefineToken, c as DefineStatement, M as MessageToken, d as MessageStatement, S as SimpleToken, e as SimpleNode, P as ProgramNode, C as Comment } from './types-DINME5SR.cjs';
export { l as CodeStatement, k as CodeToken, f as Context, F as FunctionDirective, G as Generate, h as Lex, L as Lexer, j as ObjectDirective, O as Options, i as Parse, g as Parser, T as Transform, r as resolveOptions, s as sortUserDirectives } from './types-DINME5SR.cjs';
...
declare function defineDirective<T extends Omit<SimpleToken, 'start' | 'end'>, N extends SimpleNode>(directive: Directive<T, N>): Directive<T, N>;
